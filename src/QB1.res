let innerJoin = (
  ...
  getLeftColumn: 's2 => Schema.column<'a>,
  getRightColumn: 's1 => Schema.column<'a>,
) => {
  open Joins

  let leftColumn = getLeftColumn(Utils.createColumnAccessor(1))->ColumnRef.make
  let rightColumn = getRightColumn(Utils.createColumnAccessor(0))->ColumnRef.make
