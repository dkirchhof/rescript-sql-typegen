...
/* /1* ->MyQB.where(t => Eq(Column(t.a.id), SubQuery(subQuery->Query.asSubQuery))) *1/ */
/* /1* ->MyQB.where(t => And([Eq(Column(t.a.id), Column(t.s.id)), Neq(Column(t.a.id), Column(t.s.artist))])) *1/ */
/* /1* ->MyQB.where(t => And([Eq(Column(t.a.id), Value(1)), Eq(Column(t.a.id), Value(""))])) *1/ */
/* ->Query.toSQL */
/* ->Js.log */
