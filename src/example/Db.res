...
module ArtistsTable = {
  ...
  let makeAllRecord = (id, name) => {
    artists: {
      id: Ref.Typed.unbox(id),
      name: Ref.Typed.unbox(name),
    },
  }
}
...
module ArtistsLeftJoinAlbumsLeftJoinSongs = {
  type t = {
    ar: ArtistsTable.t,
    al: AlbumsTable.optionalT,
    s: SongsTable.optionalT,
  }
  ...
  let query: Query.t<t, selectables, t> = {
    from: {name: "artists", alias: "ar"},
    joins: [
